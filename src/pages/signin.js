...
const SignIn = () => {
  ...
  const submitForm = async (value) => {
    try {
      const data = await axios.post(`${process.env.NEXT_PUBLIC_baseUrl}login`, {
        email: value.email,
              ...
              <Paper className={s.papercarde}>
                <center>
                  ...
                  <Typography variant="body">
                    A verification link was sent to your registered email address. Please check and verify your email.
                  </Typography>
                </center>{' '}
              </Paper>
            ) : (
