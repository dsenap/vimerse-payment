  ...
  const submitForm = async (value) => {
    try{
      const data = await axios
        .post(`${process.env.NEXT_PUBLIC_baseUrl}users/send-resetpass-mail`, {
          email: value.email,
            ...
            <Paper className={s.papercarde}>
              ...
              <Grid spacing={6} justify="center">
                <Grid item>
                  ...
                  <br/>
                  <br/>
                  <Typography variant='h6'>Password reset instruction have been sent to your email address</Typography>
